...
function setup() {
   ...
   zombie1 = createSprite(490,390,180,180)
   zombie1.addAnimation("zombie1", zombie)
   zombie1.scale = 0.35;
   zombie1.velocityY = 10


   zombie2 = createSprite(810,206,180,180)
   zombie2.addAnimation("zombie2", zombie)
   zombie2.scale = 0.35;
   zombie2.velocityY = 10


   zombie3 = createSprite(1105,390,180,180)
   zombie3.addAnimation("zombie2", zombie)
   zombie3.scale = 0.35;
   ...
   zombie1.setCollider("rectangle",-50,0,200,510)
   zombie2.setCollider("rectangle",-50,0,200,510)
   zombie3.setCollider("rectangle",-50,0,200,510)
...
function draw() {
   ...
   zombie1.collide(platform)
   zombie2.collide(platform2)
   zombie3.collide(platform3)
